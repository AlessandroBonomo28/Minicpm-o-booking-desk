...
SIGMA_PROMPT = ("You are the SUPERVISOR of a voice booking desk. A small speech model, the OPERATOR, talks with the CUSTOMER and reads "
                ...
                "proposals or examples. claim_month / claim_day / claim_time: the month, day and time named in the claim or proposal "
                "('How about April 15th?' -> claim_month april, claim_day 15). A proposal by the operator ('how about April 15th?', '3 pm is free, shall I book it?') is claim "
